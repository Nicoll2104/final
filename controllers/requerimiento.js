...
const httprequerimiento = {
    ...
    postRequerimiento: async (req,res)=>{
        try{
            ...
            const requerimientos = new requerimiento({codigo_presupuesto, nombre, presupuesto_inicial, año});
    ...
    putRequerimiento: async (req,res)=>{
        ...
        try{
            const requerimientos = await requerimiento.findByIdAndUpdate(id,{codigo_presupuesto, nombre, presupuesto_inicial, año}, {new: true});
